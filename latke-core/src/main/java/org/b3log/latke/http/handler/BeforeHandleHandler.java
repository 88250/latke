...
/**
 * Before processing method ({@link org.b3log.latke.http.function.ContextHandler#handle(RequestContext)} or method annotated {@link org.b3log.latke.http.annotation.RequestProcessing}).
 *
