 ...
 * 
 * <p>
 * <i>Page Cache Key</i> generated by method {@linkplain #getPageCacheKey(java.lang.String, java.lang.String)}.
 * </p>
 *
 * <p>
...
public final class PageCaches {
    ...
    /**
     * Indicates an remove cache event.
     */
    public static final String REMOVE_CACHE = "Remove Cache";
    ...
    public static void put(final String pageKey, final JSONObject cachedValue, final HttpServletRequest request) {
        ...
        LOGGER.log(Level.TRACE, "Put a page [key={0}] into page cache, cached keys [size={1}, {2}]",
     ...
     * 
     * <p>
     * A synchronous event will be fired before the removal, event type is {@value #REMOVE_CACHE}, see the {@link #REMOVE_CACHE}.
     * </p>
     *
     * <p>
