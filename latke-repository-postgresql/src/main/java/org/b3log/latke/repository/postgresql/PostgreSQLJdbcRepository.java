...
/**
 * PostgreSQL JDBC repository implementation.
 *
 * @author <a href="https://ld246.com/member/Gakkiyomi2019">Gakkiyomi</a>
 * @version 1.0.0.0, Feb 2, 2021
 */
public class PostgreSQLJdbcRepository implements Repository {

    /**
     * Logger.
     */
    private static final Logger LOGGER = LogManager.getLogger(PostgreSQLJdbcRepository.class);
    ...
    /**
     * Constructs a PostgreSQL JDBC repository with the specified name.
     *
     * @param name the specified name
     */
    public PostgreSQLJdbcRepository(final String name) {
        this.name = name;
    }
    ...
    /**
     * Builds add param list and SQL for PostgreSQL.
     *
        ...
        while (keys.hasNext()) {
            ...
            if (!keys.hasNext()) {
                if (Repositories.isSoftDelete()) {
                    paraBuilder.append(", ").append(JdbcRepositories.softDeleteFieldName);
                    argBuilder.append(", 0");
                }
                paraBuilder.append(")");
                argBuilder.append(")");
    ...
    /**
     * Builds update param list and SQL for PostgreSQL.
     *
    ...
    /**
     * Builds query SQL and count result for PostgreSQL.
     *
